...
Page({
  ...
  getFortune: function () {
    ...
    wx.request({
      ...
      success: function (res) {
        console.log(res);
        if (res.data.fail == 1 || res.data.fail == 0) {
  ...
  tipsGo: function () {
    ...
    if (that.data.tipType == 1) {
      wx.request({
        url: that.data.pddapi + 'api=pdd.ddk.rp.prom.other&channel_type=3&p_id=*****&custom_parameters=' + wx.getStorageSync('userId'),
        success(res) {
          console.log(res)
    ...
    if (that.data.tipType == 3) {
      wx.request({
        url: that.data.pddapi + 'api=pdd.ddk.rp.prom.other&channel_type=5&p_id=*****&custom_parameters=' + wx.getStorageSync('userId'),
        success(res) {
          console.log(res)
          wx.navigateToMiniProgram({
            appId: '*****',
